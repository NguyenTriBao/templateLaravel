            ...
            <div class="row my-4">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/kingkong.png" alt=""/>
                            <div class="team-content">
                                <h3 class="title">Nguyen Tri Bao</h3> <span class="post">Web Developer</span> </div>
                           
                            <div class="icon"> <i class="fa fa-plus" aria-hidden="true"></i> </div>
                        </div>
                        <div class="team-description">
                            <p>Nguyen Tri Bao</p>
                            <br>Gioi tinh: boy dep trai
                        </div>
                        <hr class="my-0"> </div>
                </div>
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/conmeo.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Tran Hoang Tan</h3> <span class="post">Web Developer</span> </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/cameo.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Tran Van Hau</h3> <span class="post">Web Developer</span> </div>
                            <div class="icon"> <i class="fa fa-plus" aria-hidden="true"></i> </div>
                        </div>
                        <div class="team-description">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent urna diam, maximus ut ullamcorper quis, placerat id eros. Duis semper justo sed condimentum rutrum. Nunc tristique purus turpis. Maecenas vulputate. </p>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/concho.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Dao Trong Tri</h3> <span class="post">Web Developer</span> </div>
