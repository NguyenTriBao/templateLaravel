        ...
        <div class="container">
            ...
            <div class="row my-5">
                ...
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                    <h2>Comments</h2>  
                    <hr width="50%" align="left" color="red" size="5px">
                        @foreach($comments as $value)
                        <ul> 
                            <li class="com-title">
                                <strong style="font-size:20px;">{{$value->com_name}}</strong>
                                
                                <br>
                                <span style="font-size:15px;">{{date('d/m/y H:i', strtotime($value->created_at))}}</span>
                            </li>
                            <li class="com-detail">
                            {{$value->com_content}}
                            </li>
                        ...
                        <div class="item">
                            <div class="products-single fix">
                                <div class="box-img-hover">
                                    <img src="{{asset('images/'.$value['image'])}}" class="img-fluid" alt="Image">
                                    <div class="mask-icon">
                                        <ul>
