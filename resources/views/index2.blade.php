            ...
            @foreach($protype as $value)
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="shop-cat-box">
                        <img src="images/{{$value->type_image}}" alt="" width="250" height="350"/>
                        <a class="btn hvr-hover" href="{{route('category',['type_id'=>$value->type_id])}}">{{$value->type_name}}</a>
                    </div>
                </div>
            @endforeach
            </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid all">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            <div class="mask-icon">
                                <ul>
                                    <li><a href="{{ route('detail2', ['id'=>$row->id]) }}" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="right" title="Compare"><i class="fas fa-sync-alt"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><i class="far fa-heart"></i></a></li>
                                </ul>
                                <a class="cart" href="{{asset('welcome')}}">Add to Cart</a>
                            </div>
                        </div>
                        <div class="why-text">
                            <h3>{{$row->name}}</h3>
                            <h4>{{$row->manufacture->manu_name}}</h5>
